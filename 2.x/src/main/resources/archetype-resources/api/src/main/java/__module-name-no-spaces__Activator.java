...
import ${groupId}.ModuleActivator;

/**
 * This class contains the logic that is run every time this module is either started or stopped.
 */
public class ${module-name-no-spaces}Activator implements ModuleActivator {
	...
	public void willRefreshContext() {
		log.info("Refreshing ${module-name} Module");
	}
	...
	public void contextRefreshed() {
		log.info("${module-name} Module refreshed");
	}
	...
	public void willStart() {
		log.info("Starting ${module-name} Module");
	}
	...
	public void willStop() {
		log.info("Stopping ${module-name} Module");
	}
